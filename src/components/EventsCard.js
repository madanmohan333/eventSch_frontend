...
const EventsCard = (props) => {
  ...
  const handleStatusChange = async (e) => {
    ...
    if (role !== "organizer") {
      ...
      props.setMessage1("Only organizers can change status");
  ...
  return (
    ...
    >
      <div className="firstRow">
        ...
        {/* ✅ Show toggle only for organizer */}
        {role === "organizer" && (
      ...
      <div className="secondRow">
        {props.tags.length <= 3 ? (
          props.tags.map((tag) => (
            <Tags key={tag} title={tag} darkTheme={props.darkTheme} />
          ))
        ) : (
          <>
      ...
      <div className="thirdRow">
            ...
            props.collaborators.map((collaborator) => (
              <span className="dp" key={collaborator._id}>
                <img
                  ...
                  alt="collabs"
                  onError={(e) => {
                    e.target.src = `${host}/uploads/defaultUpload.png`;
                  }}
                  width="48px"
                />
              </span>
        ...
        {/* ✅ Show edit button only for organizer */}
        {role === "organizer" && (
          <span
            className="edit_btn"
